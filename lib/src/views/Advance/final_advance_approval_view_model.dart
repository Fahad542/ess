...
class final_advance_viewmodel extends ReactiveViewModel with AuthViewModel, ApiViewModel
{
  ...
  gefinalApprovalData(
    ...
    var newsResponse = await runBusyFuture(apiService.finaladvanceapproval(context));
