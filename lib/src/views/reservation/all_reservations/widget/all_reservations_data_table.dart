...
class AllReservationsTableData {
...
class AllReservationsDataTable extends StatelessWidget {
  final AllReservationsTableData heading;
  final List<AllReservationsTableData> data;
  final ValueChanged<int> onTap;

  const AllReservationsDataTable({
    Key? key,
